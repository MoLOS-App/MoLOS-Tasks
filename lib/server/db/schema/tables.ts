...
import { TaskStatus, TaskPriority, ProjectStatus } from '$lib/models/external_modules/MoLOS-Tasks';
...
export const tasksTasks = sqliteTable('MoLOS-Tasks_tasks', {
	...
	isCompleted: integer('is_completed', { mode: 'boolean' }).notNull().default(false), // Checkbox: "Done"
...
export const tasksDailyLog = sqliteTable('MoLOS-Tasks_daily_log', {
	...
	morningRoutine: integer('morning_routine', { mode: 'boolean' }).default(false), // Checkbox
	eveningRoutine: integer('evening_routine', { mode: 'boolean' }).default(false), // Checkbox
